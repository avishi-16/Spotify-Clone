...
const Player = () => {
    ...
    return (
        <div className="h-[10%] bg-black flex justify-between items-center text-white mt-6">
            ...
            <div className="flex flex-col items-center gap-1 m-auto">
                ...
                <div className="flex items-center gap-5">
                    <p>1:06</p>
                    <div ref={seekBg} className="w-[70vw] max-w-[500px] bg-gray-300 rounded-full cursor-pointer">
                        <hr ref={seekBar} className="h-1 border-none w-0 bg-green-800 rounded-full" />
                    </div>
                    <p>3:20</p>
                </div>
            </div>
            <div className="hidden lg:flex items-center gap-3 opacity-75 mt-6 pr-6">
